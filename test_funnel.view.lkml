  ...
  derived_table: {
    sql: SELECT
          ...
          ,CASE WHEN hits_appInfo.screenName = 'food_dashboard' THEN 1
                ...
                WHEN hits_appInfo.screenName = 'RecipeDetails' THEN 3 END
                --WHEN  hits_appInfo.screenName like 'food_browse_recipes%' THEN 3 END
            AS page_sequence
          , LAG(
           CASE WHEN hits_appInfo.screenName = 'food_dashboard' THEN 1
                WHEN hits_appInfo.screenName = 'food_browse_recipes' THEN 2
                WHEN hits_appInfo.screenName = 'RecipeDetails' THEN 3 END, 1
                --WHEN  hits_appInfo.screenName like 'food_browse_recipes%' THEN 3 END
              )
         ...
         , LAG(
               CASE WHEN hits_appInfo.screenName = 'food_dashboard' THEN 1
                WHEN hits_appInfo.screenName = 'food_browse_recipes' THEN 2
                WHEN hits_appInfo.screenName = 'RecipeDetails' THEN 3 END, 2
                --WHEN  hits_appInfo.screenName like 'food_browse_recipes%' THEN 3 END
              )
         ...
         , LAG(
               CASE WHEN hits_appInfo.screenName = 'food_dashboard' THEN 1
                WHEN hits_appInfo.screenName = 'food_browse_recipes' THEN 2
                WHEN hits_appInfo.screenName = 'RecipeDetails' THEN 3 END, 3
                --WHEN  hits_appInfo.screenName like 'food_browse_recipes%' THEN 3 END
              )
...
-- CASE WHEN hits_appInfo.screenName = 'food_dashboard' THEN 1
--                WHEN hits_appInfo.screenName = 'food_browse_recipes' THEN 2
--                WHEN  REGEXP_CONTAINS(hits_appInfo.screenName , 'food_browse_recipes*') THEN 3
--           END IS NOT NULL
