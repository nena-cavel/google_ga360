...
dimension: group_id_name {
  ...
  sql: case when ${group_id_new} = '6ad99fd2-3dd7-4bf6-ae09-7bdb5f940395' then 'Black Women'
            ...
            when ${group_id_new} =  'c2e152bf-a503-4c6e-9e7e-b25820bd6a9a' THEN 'Sacramento Members'
            when ${group_id_new} =  '5e94fc54-4b92-4e35-8cbf-973c6d0a95a9' THEN 'Fotografie'
            when ${group_id_new} =  'c82b7f80-ad69-49dc-a5b4-0fa3b52f57e2' THEN 'South West'
            when ${group_id_new} =  'f227c815-5705-4294-89ef-ee4e6b1f1eb7' THEN 'Home Counties'
            when ${group_id_new} =  '2129cb30-8a34-456e-a5bc-36a171e3317a' THEN 'Wijnliefhebbers'
            when ${group_id_new} =  'f9fc63a9-e736-4296-b546-32a33a2c9a49' THEN 'Scotland'
            when ${group_id_new} =  '956da33d-5de0-43eb-979f-3ea0541be575' THEN 'Minneapolis Members'
             when ${group_id_new} =  '8f3130d1-e759-4cf0-9002-696545fdf737' THEN 'Miami Members'
             when ${group_id_new} =  'bc4cea6a-3daf-4d58-8b9e-8fcc6987aa59' THEN 'Dansen'
             when ${group_id_new} =  'fa53aa22-9b9f-47b2-9937-bc53362f3557' THEN 'Denver Members'
          when ${group_id_new} =  '5600d45e-4466-49a0-a3e5-3082468e7a14' THEN 'Berlin'
          when ${group_id_new} =  '02825a51-4ef6-43d6-9e86-74282a417096' THEN 'Toronto'
          when ${group_id_new} =  '1da055de-ecd7-4cce-88d4-7f5d0aadd02c' THEN 'Calgary'
          when ${group_id_new} =  'd7677996-dbfd-459d-b8c8-868ce8716615' THEN 'Edmonton'
          when ${group_id_new} =  '43323525-4bac-43dd-82b7-f63c4ffe376a' THEN 'Chicago'
          when ${group_id_new} =  '6e74b8f2-6538-4177-b3bd-9db91a734854' THEN 'Los Angeles Members'
          when ${group_id_new} =  '0d612301-b265-4afe-8853-f0f6c583965d' THEN 'Atlanta Members'
          when ${group_id_new} =  '6eb3167d-4681-40f4-a080-9f31f597f760' THEN 'Uppland'
          when ${group_id_new} =  'd7b7c1bd-6295-42b5-837b-7e74c177952c' THEN 'Oprahs 2020 Tour'
          when ${group_id_new} =  'e7a9407f-7d37-4954-9efd-50a87dd517ec' THEN 'Bordeaux'
          when ${group_id_new} =  '1cb6f07a-d954-40b8-82da-3503e00b7a78' THEN 'Handgemacht'
          when ${group_id_new} =  '8157195c-a55b-4c79-bbb2-d3d97cbe89c4' THEN 'Peloton Lovers'
          when ${group_id_new} =  'ab89d4df-50a5-4863-9490-692bcd687bd0' THEN 'Radfahren'
          when ${group_id_new} =  'f660d8e2-729e-4495-8426-914fc622fa65' THEN 'Ruhrgebiet'
          when ${group_id_new} =  '313a7c32-9f6d-49c9-977c-bb06ebf50166' THEN 'Objectif bleu'
          when ${group_id_new} =  'd0319053-f972-4efc-9c2c-e77643fa32ec' THEN 'Yorkshire'
          when ${group_id_new} =  '68980c58-f821-4e64-ace0-3332c4632d5b' THEN 'Swimming'
          when ${group_id_new} =  'a170c5cf-1e10-4ecf-8c4b-5e58dbfa7619' THEN 'Mainz'
          when ${group_id_new} =  '9c838592-7625-4ea2-8d1b-1245e0d160c8' THEN 'Hannover'
          when ${group_id_new} =  '3357611e-d753-44d9-a178-6b86438b5470' THEN 'South East'
          when ${group_id_new} =  'eac891e5-f964-4794-866c-a6ec0582d735' THEN 'North East'
          when ${group_id_new} =  '14c07d18-0fbe-4311-8711-04c1411229f0' THEN 'Stuttgart'
          when ${group_id_new} =  '17d0cd7c-1265-4855-9f76-21e7424c1241' THEN 'Dresden'
          when ${group_id_new} =  '5916aa69-f3df-48fe-aa48-3c47da09e721' THEN 'Aachen'
          when ${group_id_new} =  '557e617f-de96-43eb-8ede-9ca270da8c67' THEN 'Munchen'
           when ${group_id_new} =  'd47970d3-aa0d-4d82-b503-7f40c2e98da2' THEN 'Saskatchewan'
          when ${group_id_new} =  'd0e03575-3abf-4e31-8e52-51f4c4606b36' THEN 'Colorado Members'
           when ${group_id_new} =  '68a474a9-ad65-41f9-95d4-59e1ebc90c93' THEN 'Wales'
        when ${group_id_new} =  'cb282951-7078-4e8a-8e2d-46bb7de71ed0' THEN 'New Brunswick '
        when ${group_id_new} =  'e73ca82d-aa48-457f-80e7-a4b250057d5c' THEN 'Wiesbaden'
        when ${group_id_new} =  '7c0898e6-698a-4c12-95c0-987c5ef57e43' THEN 'Mannheim'
        when ${group_id_new} =  'cccd4c25-49a9-4c22-8c53-0a00099e5f5d' THEN 'Dortmund'
         when ${group_id_new} =  'cc880f81-7b5c-4028-8c98-19489330615f' THEN 'Over 65 and loving life'
         when ${group_id_new} =  'a1c5e7e2-4103-4655-93f3-3f85ddd58eef' THEN 'Newfoundland & Labrador'
         when ${group_id_new} =  '264fc37d-b091-4eb4-bfcf-18ba54ff56a5' THEN 'WW Studio International'
         when ${group_id_new} =  '992056c3-e28e-43c6-b58d-8130e00be34d' THEN 'WW Studio International'
         when ${group_id_new} =  'dc7498fc-b0a0-408e-8ca1-c084de48cb09' THEN 'Diese Gruppe wird gelöscht'
        when ${group_id_new} =  '82f2c0aa-8729-498a-8493-749a90123962' THEN 'Halland'
        when ${group_id_new} =  'ba3a281d-8d16-4bf9-a356-da3f6e35b122' THEN ' Västerbottent'
         when ${group_id_new} =  'cbabb8c7-bc4a-49fb-8b9e-71313b0e89c7' THEN 'Västergötland'
         when ${group_id_new} =  '5f1f8c06-d70a-48a9-b7e0-04365f6f7fd4' THEN 'Västmanland'
         when ${group_id_new} =  '0959e6ef-10e9-4e33-8c58-6fc5fc66ce31' THEN 'WW Good'
         when ${group_id_new} =  'fdebf3ef-9abc-4446-87b1-c81d98ff232b' THEN 'WW Shift Workers'
         when ${group_id_new} =  '35e0d000-98b4-45a5-b33c-2bbd2c920259' THEN 'WW Studio Amsterdam'
        when ${group_id_new} =  'e5779e53-a6a4-452c-a657-52f2b058a92d' THEN 'Wenns mal wieder länger dauert'
        when ${group_id_new} =  '454c3a81-c6de-4559-ba02-8a5089acdc78' THEN 'WW onderweg'
        when ${group_id_new} =  'afb625b1-7d8e-4c37-97e7-cf31490740a3' THEN 'Winnipeg'
        when ${group_id_new} =  '242c66f1-b388-4f10-abe8-9d51b06a0409' THEN 'Working Parents'
        when ${group_id_new} =  'f2b780e8-32cc-4e48-82cd-84b84401b6f0' THEN ' Öland'
