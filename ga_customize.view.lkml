...
dimension: tracked_food {
  ...
  dimension: headspace_card_name {
    ...
    'Accordez_vous_une_pause', 'Prenez_un_moment_pour_faire_une_pause'))then 'Take a Moment to Pause'
    ...
    'food_card_mindset_Fin_de_journ_e') or ${eventLabel} in ('End_of_Day', 'Fin_de_la_journ_e', 'Slut_p__dagen', 'Fin_de_journ_e', 'Einde_van_de_dag')) then 'End of Day'
